...
/// As previously mentioned, the Mae Controller Kit can communicate over both 
...
//{
  ...
  public class OSC : MonoBehaviour
  {
	...
	[Header("[Format: Set in and out port the same value to broadcast value]")]
    public int inPort  = 12688;
	public string remoteIP = "192.168.1.255";
    public int outPort  = 12688;
